...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_ogrenich/28d8d092db0899d1cc46197516295cd6/execroot/__main__',
    'ios_x86_64',
    {
        'tvos_arm64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/ogrenich/Library/Application Support/Tulsi/0.20200219.88/Bazel',
